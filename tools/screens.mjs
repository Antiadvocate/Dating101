  ...
  return {
    ...
    history: [
      ...
      { turn: 7, kind: "turn", player_action: "Ask her what she's counting.", action_mode: "say",
        narrator_prose: "Vesna's hands come up together, tuck her hair behind both ears before she's quite finished settling her weight from one hip to the other. \"Anchovies.\" A short laugh, mostly breath. \"Somebody has taken four tins and I would like to know who, because it is not a thing you steal by accident.\" She turns the clipboard round so you can see it, which is more of an answer than the question deserved.\n\n\"You could have miscounted on Tuesday.\"\n\n\"I could have.\" She takes the clipboard back and puts the pen through her hair. \"I didn't.\"\n\nThe column is neat. The subtraction is neat. Four tins. She calls it a \"system\", which it is not.",
